(function () {
  ...
  Pages = (function () {
    function Pages() {
      this.browserSupportsCSSProperty = bind(
  ...
  Slideshow = (function (superClass) {
    ...
    Slideshow.prototype.addImageToSlideshow = function (image, loadTime) {
      ...
      imageWidth =
        image[0].width === 0
          ? $("#slideshow .slide")[0].width
          : image[0].width / 2;
      image.attr("width", imageWidth).appendTo("#slideshow");
      return this.fadeInSlideAfterDelayAtIndex(
        $("#slideshow .slide").length - 1,
        loadTime
      );
    };

    Slideshow.prototype.fadeInSlideAfterDelayAtIndex = function (
      slideIndex,
      shortenDelay
    ) {
      var delay;
        ...
        .each(
          (function (_this) {
            return function (i, element) {
              if (
                $(element).offset().top + _this.animateInOffset <
